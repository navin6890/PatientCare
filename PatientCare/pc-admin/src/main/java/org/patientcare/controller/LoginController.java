...
public class LoginController 
{
	...
	public String signIn(@ModelAttribute("admin")AdminLogin admin,ModelAndView model,HttpServletRequest req) throws Exception //yah vahi object hai jo hamne uper "login" me bind kiya tha. yahi fill hoke aaya hai AdminUser se
	{
